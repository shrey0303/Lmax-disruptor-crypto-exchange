package shrey.benchmarkcluster.transport.rest;

import shrey.bank.proto.BalanceCommandServiceGrpc;
import shrey.benchmarkcluster.infra.cluster.BalanceCommandStub;
import shrey.benchmarkcluster.common.commands.DepositCommand;
